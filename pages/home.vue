...
export default {
  data() {
    return {
      latestProducts: [
        { id: 1, name: "Smartfon XYZ", price: 1999, image: "http://localhost:3000/smartfon.png" },
        { id: 2, name: "Koszula w kratkę", price: 99.99, image: "http://localhost:3000/koszula.png" },
        { id: 3, name: "Książka 'Rodzice w akcji'", price: 49.90, image: "http://localhost:3000/ksiazka.png" }
      ],
      promotions: [
        { id: 1, name: "Promocja na elektronikę", description: "Taniej o 20%!" },
        { id: 2, name: "Wyprzedaż wiosenna", description: "Największe obniżki sezonu!" }
      ],
      popularCategories: [
